# Thao Duong - Social Network Analysis
...
ui <- fluidPage(
  ...
  # Assignment title
  br(),
  titlePanel("ThaoDuong_Social_Network_Analysis", windowTitle="ThaoD_SNA"),
  br(),
  ...
  sidebarPanel(
    ...
    numericInput("number", "Number of Connections:",2, min=0, max=102),
